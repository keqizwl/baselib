...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect rect, View v, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mShowLastDivider && position >= itemCount - lastDividerOffset) {
            // Don't setPrimaryToolbar item offset for last line if mShowLastDivider = false
            return;
        }
            ...
            if (mPaintProvider != null) {
                if (mColorProvider != null) {
                    throw new IllegalArgumentException(
                            "Use setColor method of Paint class to specify line color. Do not provider ColorProvider if you setPrimaryToolbar PaintProvider.");
                }
                if (mSizeProvider != null) {
                    throw new IllegalArgumentException(
                            "Use setStrokeWidth method of Paint class to specify line size. Do not provider SizeProvider if you setPrimaryToolbar PaintProvider.");
                }
            }
        }
    }
